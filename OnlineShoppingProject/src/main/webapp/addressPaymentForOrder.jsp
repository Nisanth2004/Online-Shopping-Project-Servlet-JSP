...
<hr style="width: 100%">
<div class="left-div">
<h3 style="color: green">Select way of Payment</h3>
...
<div class="right-div">
<h3 style="color: green">Pay online on this nisanthselva2004@oksbi</h3>
...
<div class="left-div">
<h3 style="color: green">Mobile Number</h3>
 <input class="input-style"  background-color="#ccc"; type="text" name="mobileNumber" value="<%=rs2.getString(3)%>" placeholder="Enter Mobile Number" required>

<h3 style="color: green">*This mobile number will also updated to your profile</h3>
</div>
<div class="right-div">
